...
#define _nstates5	3	/* P5 */
#define minseq5	302
#define maxseq5	303
#define _endstate5	2

#define _nstates4	3	/* P4 */
#define minseq4	300
#define maxseq4	301
#define _endstate4	2

#define _nstates3	3	/* P3 */
#define minseq3	298
#define maxseq3	299
#define _endstate3	2

#define _nstates2	3	/* P2 */
#define minseq2	296
#define maxseq2	297
#define _endstate2	2

#define _nstates1	3	/* P1 */
#define minseq1	294
#define maxseq1	295
#define _endstate1	2

#define _nstates0	295	/* Chosed */
#define minseq0	0
#define maxseq0	293
#define _endstate0	294
...
#define Air0	(sizeof(P0) - Offsetof(P0, pair_index) - 1*sizeof(int))
...
typedef struct State {
	...
	unsigned is_boat_in_center : 1;
	unsigned turn : 1;
	unsigned local_turn : 1;
	uchar count;
	uchar wedding[6];
	int boat_seats[2];
#ifdef TRIX
