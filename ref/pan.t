...
{	Trans *T;
	...
	trans[2][5]	= settr(38,0,4,1,0,".(goto)", 0, 2, 0);
	T = trans[2][4] = settr(37,0,0,0,0,"DO", 0, 2, 0);
	    T->nxt	= settr(37,0,3,0,0,"DO", 0, 2, 0);
	T = trans[ 2][3] = settr(36,2,0,0,0,"ATOMIC", 0, 2, 0);
	T->nxt	= settr(36,2,1,0,0,"ATOMIC", 0, 2, 0);
	trans[2][1]	= settr(34,0,4,3,3,"(!((1==334)))", 0, 2, 0); /* m: 2 -> 4,0 */
	reached2[2] = 1;
	trans[2][2]	= settr(0,0,0,0,0,"assert(!(!((1==334))))",0,0,0);
	trans[2][6]	= settr(39,0,7,1,0,"break", 0, 2, 0);
	trans[2][7]	= settr(40,0,8,1,0,"(1)", 0, 2, 0);
	trans[2][8]	= settr(41,0,0,4,4,"-end-", 0, 3500, 0);
